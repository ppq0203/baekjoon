...
int move(char[MAX][MAX], int[4], int[2], int[MAX][MAX][MAX][MAX], int, int, std::stack<int*>*);
...
int move(char maps[MAX][MAX], int nowrb[4], int goal[2], int rbdata[MAX][MAX][MAX][MAX], int udmove, int lrmove, std::stack<int*> *pushS)
{
	int r[2], b[2];
	r[0] = nowrb[0];
	r[1] = nowrb[1];
